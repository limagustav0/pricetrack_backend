...
async def buscar_produtos_amazon(ean, descricao, cliente, is_kit=False, tentativas=3):
        ...
        try:
            async with async_playwright() as p:
                ...
                for card in cards:
                    ...
                    marca_el = await card.query_selector("span.a-size-base")  # Tentativa de extrair marca
...
async def buscar_varios_produtos(lista_produtos, cliente="Época Cosméticos", is_kit=False):
    resultados = []
    ...
    async with async_playwright() as p:
        ...
        for item in lista_produtos:
            ...
            produto = await buscar_produtos_amazon(ean, descricao, cliente, is_kit)
...
if __name__ == "__main__":
    ...
    asyncio.run(buscar_varios_produtos(lista, cliente="Época Cosméticos", is_kit=False))